...
public class VoiceConnectActivity
        ...
        implements ServiceConnection, DroneReadyReceiverDelegate, DroneConnectionChangeReceiverDelegate
{
    ...
    private static final int[] TIPS_my = {
            R.layout.hint_my_wait
    };

    private static final String TAG = VoiceConnectActivity.class.getSimpleName();
...
//            setContentView(TIPS[tipNumber]);
    ...
    private void prepareGoogleTVControls()
    {
        ...
        autoSkipCheck.setOnCheckedChangeListener(new OnCheckedChangeListener()
        {
            ...
            {
                VoiceConnectActivity.this.setAutoSkip(isChecked);
            }
        });
    }
    ...
    {
        Intent droneControlActivity = new Intent(VoiceConnectActivity.this, VoiceControlDroneActivity.class);
